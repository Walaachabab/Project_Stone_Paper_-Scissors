...
## 🚀 Overview
This project focuses on applying core programming concepts and building a clean, modular code structure. The game allows the user to play multiple rounds against the computer, tracks wins/losses/draws, and provides a final summary report.

## 🛠️ Concepts Applied
In this project, I successfully implemented:
* **Enums & Structs**: To manage game types (Stone, Paper, Scissors) and aggregate game results.
* **Modular Programming**: Divided the logic into several specialized functions (Single Responsibility Principle).
* **Input Validation**: Ensuring user inputs are within the expected range (1-10 rounds).
* **Randomness**: Utilizing `srand()` and `rand()` for computer move generation.
* **Advanced Flow Control**: Managing nested logic and game loops.
